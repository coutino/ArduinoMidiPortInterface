 ...
 */
  ...
  *    Creacion de las estrcuturas para el almacenamiento de una nota midi o bien un pad.
  *    Se agrega el display como forma de visualizar las configuraciones y notas midi
  *    Se agregan opciones de configuracion
  *          Cambiar el valor de una nota midi para cada sensor
  *          Cambiar la sensibilidad del piezoelectrico para cada sensor
  *          Se puede cambiar el el valor del canal MIDI
  *          Cambiar el modo del puerto de salida del MIDI. Puede ser via puerto MIDI o puerto USB
  *          Se pueden guardar todas las opciones anteriores
  *          Se puede regresar a los valores por defaul
